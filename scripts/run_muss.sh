...
export PYTHONPATH=$PYTHONPATH://fs/clip-scratch/sweagraw/gpt-eval/llm_inference/muss
...
split="test"
for model_name in muss_en_wikilarge_mined; do
	for dataset in med-easi; do
